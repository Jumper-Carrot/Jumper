...
import { Sheet, SheetContent } from '@/components/@materials/ui/sheet'
...
<template>
  ...
  >
    ...
    >
      <div
        data-sidebar="sidebar"
        class="text-sidebar-foreground bg-sidebar
          group-data-[variant=floating]:border-sidebar-border flex h-full w-full

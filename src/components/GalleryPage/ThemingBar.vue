<template>
  <div
    ...
    class="flex h-[28px] items-center justify-end gap-2 border-y bg-slate-50 px-2
  ...
  >
    <div class="flex h-full items-center">
      ...
      <button
        class="group ml-2 rounded-full p-[3px] transition-colors hover:bg-slate-200
          dark:hover:bg-slate-800"
      >
        <Save
          class="h-[17px] w-[17px] text-slate-700 transition-colors group-hover:text-slate-900
...
import { Sun, X, Save } from 'lucide-vue-next'

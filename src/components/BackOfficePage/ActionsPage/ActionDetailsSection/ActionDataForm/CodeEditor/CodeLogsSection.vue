<template>
  <div class="h-[400px]">
    <div
      class="flex h-[40px] w-full items-center border-slate-300 bg-slate-200
        px-2 shadow-xs dark:bg-slate-800"
    >
      <p class="text-slate-500 italic dark:text-slate-300">Logs</p>
      <Button
        class="ml-auto flex h-[23px] w-[23px] items-center justify-center
          border-b-2 bg-slate-50 p-3 text-sm text-slate-700 hover:bg-slate-100
          hover:text-slate-950 dark:bg-slate-700 dark:text-slate-200
    ...
    <div
      class="h-[360px] overflow-auto bg-slate-200 shadow-inner
        dark:bg-slate-800"
    >
      <div
        ...
        :class="{
          'bg-opacity-60 dark:bg-opacity-30 bg-slate-300 dark:bg-slate-700':
